...
public class ReportSpace implements Specification<AcountFee> {
	...
	public ReportSpace(String className, String studentName, String uidNo, String idNo, String registerNo,
			String paymentName) {
		super();
