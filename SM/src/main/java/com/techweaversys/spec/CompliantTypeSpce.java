...
public class CompliantTypeSpce implements Specification<CompliantTypes> {
	...
	public CompliantTypeSpce(String name, String code) {
		super();
		this.name = name;
		this.code = code;
	}
	...
	@Override
	public Predicate toPredicate(Root<CompliantTypes> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
