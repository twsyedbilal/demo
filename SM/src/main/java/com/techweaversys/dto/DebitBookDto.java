...
//	private Long admissionId;
	...
	public DebitBookDto(Long id, String type, Long admissionId, List<DebitSlaveDto> debitSlave, AdmissionDto admission) {
		super();
		this.id = id;
		this.type = type;
...
//			return false;
	...
	public String toString() {
		return "DebitBookDto [id=" + id + ", type=" + type + ", debitSlave=" + debitSlave + ", admission=" + admission
				+ "]";
	}
