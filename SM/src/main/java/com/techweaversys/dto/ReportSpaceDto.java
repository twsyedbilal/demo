...
public class ReportSpaceDto {
	...
	public ReportSpaceDto() {
		super();
	}

	public ReportSpaceDto(String classs, String studentName, String uidNo, String idNo, String registerNo,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReportSpaceDto other = (ReportSpaceDto) obj;
		if (classs == null) {
	...
	public String toString() {
		return "ReportSpaceDto [classs=" + classs + ", studentName=" + studentName + ", uidNo=" + uidNo + ", idNo="
