...
public class Constants {
	...
	// log
	public static final String IDCARD = "ID CARD GENERATED";
	public static final String BONAFIDE_SCHOOL = "BONAFIDE GENERATED AS PER SCHOOL RECORD";
	public static final String BONAFIDE_SCHOOL_BIRTH = "BONAFIDE ENGLISH SCHOOL GENERATED AS PER BIRTH CERTIFICATE";
	public static final String BONAFIDE_JUNIOR_SCIENCE_ADMISSION_NO = "BONAFIDE GENERATED WITH ADMISSION NO AS PER JUNIOR COLLEGE SCIENCE REGISTER RECORD";
	public static final String BONAFIDE_JUNIOR_COLLEGE = "BONAFIDE GENERATED FOR JUNIOR COLLEGE AS PER COLLEGE REGISTER RECORD";
	public static final String BONAFIDE_SCHOOL_ADMISSION_NO = "BONAFIDE GENERATED WITH ADMISSION NO";
	public static final String BONAFIDE_JUNIOR_SCIENCE = "BONAFIDE GENERATED WITH ADMISSION NO AS PER JUNIOR COLLEGE SCIENCE REGISTER RECORD";
	public static final String BONAFIDE_PAST_JUNIOR_SCIENCE = "BONAFIDE GENERATED FOR PAST STUDENT AS PER JUNIOR COLLEGE SCIENCE REGISTER RECORD";
	public static final String PRIMARY_TC = "PRIMARY TC GENERATED";
	public static final String HIGH_SCHOOL_TC = "HIGH SCHOOL GENERATED";
	public static final String JUNIOR_COLLEGE_TC = "JUNIOR COLLEGE GENERATED";
